...
| **Pseudo**                     | Obligatoire, unique, 3-20 caractères. Validation côté serveur de l'unicité. Suggestion automatique si pris.                                                                             |
| **Skip**                       | Disponible uniquement sur E6-02. Le joueur arrive au Hub sans méta-personnage construit. Il peut jouer normalement mais n'a pas les bénéfices du tutoriel.                              |
