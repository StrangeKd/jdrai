...
# Handoff References
# Note: game-architecture workflow removed (not applicable for web app projects)
---
...
1. **Create Script/Screenplay** - Write the actual dialogue and scenes
...
1. Review the narrative document
2. Exit workflow"
