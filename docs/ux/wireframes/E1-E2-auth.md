...
| Onboarding redirect    | **Register → Onboarding (E5)**  | Register → Hub                              | Les nouveaux joueurs passent systématiquement par l'onboarding. Login → Hub (seule exception : pseudo absent → Onboarding E6-01).                                                                                                                                                 |
...
| -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| Saisie email + password + tap "Connexion" (E1)           | Spinner sur le bouton. Succès → redirect Hub (E8). Seule exception : si pseudo absent → redirect Onboarding E6-01. Erreur → WF-AUTH-02. |
...
| **Redirect après login**    | Toujours → Hub (E8). Seule exception : si le pseudo est absent dans les données User (compte sans pseudo défini) → Onboarding E6-01 (choix pseudo, obligatoire). Aucune autre redirection vers l'onboarding.                                                                                                                                                                                 |
...
| **OAuth (P2+)**             | Séparateur `── ou ──` visible en P1 comme **placeholder UI**. En P2+, les boutons OAuth (Google, Discord) seront ajoutés sous le séparateur. En P1, le séparateur est affiché sans boutons en dessous — sert de repère visuel pour la future fonctionnalité.                                                                                                                                 |
