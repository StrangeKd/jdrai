...
### WF-E11-05 — Erreur backend (chargement global)
...
- Différent de WF-E11-03 (erreur LLM uniquement) : ici **aucune donnée** n'est disponible (milestones, récompenses, résumé)
...
| Tap "Réessayer" (WF-E11-05)              | Recharge toute la page (erreur backend globale). Succès → affichage normal. Échec → reste sur WF-E11-05.                               |
