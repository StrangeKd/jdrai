---
description: JDRAI project customizations for GDS agents (game-specific)
globs: []
alwaysApply: false
---

# JDRAI - GDS Agents Customization

This rule applies JDRAI-specific customizations to relevant Game Dev Studio (GDS) agents.
...
- **BMM agents customization**: `.cursor/rules/jdrai-bmm-agents.md`
